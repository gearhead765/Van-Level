...
- **Project Box:**  [Hammond 1551KFLBK](https://www.digikey.com/en/products/detail/hammond-manufacturing/1551KFLBK/2094805)
    - **Screws to Secure Board in Enclosure (2 per Project):** [Metric socket cap, Class 12.9 alloy steel black oxide finish, 2mm x 0.4mm x 5mm](https://boltdepot.com/Product-Details?product=13322)

## Modifications to Off the Shelf Hardware
The Hammond enclosure will need a cutout for the Phoenix power connector.  The top will need a tall opening, while the bottom will need the lip removed in the connector area.  Two small washers can be 3D printed to lift the board just a little so the connector will fit in the enclosure.

- TODO - STL file for washers
- TODO - PDF drawing on enclosure cutout

## The PCB
[Kicad](https://www.kicad.org/) was used to design the very simple carrier board for the ESP32 development board and the IMU breakout board.  This eliminated the need for point-to-point wiring and made a much more compact package possible.  You can also construct this project on strip board, dead bug style, or how ever you want.
